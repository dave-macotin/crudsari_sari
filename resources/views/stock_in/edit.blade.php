...
<div class="d-flex align-items-center mb-4">
    ...
    <h4 class="fw-bold mb-0">Edit Stock In</h4>
</div>

<div class="card" style="max-width:580px;">
    <div class="card-body p-4">
        @include('layouts.errors')
        <form action="{{ route('stock_in.update', $stock_in->stockin_id) }}" method="POST">
            @csrf @method('PUT')
            <div class="mb-3">
                ...
                <select name="product_id" id="product_id" class="form-select @error('product_id') is-invalid @enderror">
                    ...
                    @foreach($products as $product)
                        <option value="{{ $product->product_id }}" {{ old('product_id', $stock_in->product_id) == $product->product_id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <select name="supplier_id" id="supplier_id" class="form-select @error('supplier_id') is-invalid @enderror">
                    ...
                    @foreach($suppliers as $supplier)
                        <option value="{{ $supplier->supplier_id }}" {{ old('supplier_id', $stock_in->supplier_id) == $supplier->supplier_id ? 'selected' : '' }}>
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <input type="number" name="quantity_added" id="quantity_added" min="1"
                           ...
                           value="{{ old('quantity_added', $stock_in->quantity_added) }}">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" min="0" name="stock_in_price" id="stock_in_price"
                               ...
                               value="{{ old('stock_in_price', $stock_in->stock_in_price) }}">
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" name="stockin_date" id="stockin_date"
                       ...
                       value="{{ old('stockin_date', $stock_in->stockin_date->format('Y-m-d')) }}">
            ...
            <div class="mb-4">
                ...
                <textarea name="notes" id="notes" rows="2"
                          ...
                          placeholder="Optional notes">{{ old('notes', $stock_in->notes) }}</textarea>
